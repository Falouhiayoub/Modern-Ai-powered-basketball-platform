...
export function Matches() {
  ...
  const { data: pastMatches, isLoading: pastLoading, error: pastError } = useQuery<Match[]>({
    ...
    queryFn: () => matchService.getRecentResults(),
  });
      ...
      <div className="max-w-7xl mx-auto space-y-40">
        ...
        <section>
          ...
          {upcomingLoading ? (
            ...
            <div className="glass-card p-12 text-center text-zinc-500">Error loading schedule.</div>
        ...
        <section>
          ...
          {pastLoading ? (
            ...
            <div className="glass-card p-12 text-center text-zinc-500">Error loading results.</div>
